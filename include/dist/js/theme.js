! function (e, s, i) {
    ...
    i(s).ready(function () {
        ...
        t.on("click", ".navigation-main .nav-item a", function () {
            ...
            "expanded" === e.attr("data-toggle") ? (l.addClass("nav-collapsed"), (document.getElementById("zSidebar").style.zIndex = "1"), (document.getElementById("showLogo").style.display = "block"), (document.getElementById("expandSidebar").style.left = "0px"),
                i(".nav-toggle").find(".toggle-icon"),
                e.attr("data-toggle", "collapsed")) : (l.removeClass("nav-collapsed menu-collapsed"), (document.getElementById("zSidebar").style.zIndex = "1040"), (document.getElementById("showLogo").style.display = "none"), (document.getElementById("expandSidebar").style.left = "85px"), i(".nav-toggle").find(".toggle-icon"),
