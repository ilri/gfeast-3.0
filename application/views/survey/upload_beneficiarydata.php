								...
								switch ($value['type'] ) {
									...
									case 'lkp_state': ?>
										<div class="form-group">
											...
											<select name="field_<?php echo $value['field_id']; ?>" class="form-control" data-required="<?php echo ($value['required'] == 1) ? 'required' : ''; ?>" id="state">
									...
									case 'lkp_district': ?>
										<div class="form-group">
											...
											<select name="field_<?php echo $value['field_id']; ?>" class="form-control" data-required="<?php echo ($value['required'] == 1) ? 'required' : ''; ?>" id="district">
									...
									case 'file': ?>
										<div class="form-group">
											...
											<input type="file" name="field_<?php echo $value['field_id']; ?>[]" class="<?php echo $value['className']; ?> <?php echo $value['subtype']; ?>" data-maxfile = "<?php echo $value['maxlength']; ?>" data-required="<?php echo ($value['required'] == 1) ? 'required' : ''; ?>">
											<p class="error red-800"></p>
...
<script type="text/javascript">
	$(function(){
		...
		$('#state').on('change', function(){
			...
			var beneficiary_id = $('select[name="beneficiary_id"]').val();
			var country_id = $('select[name="country_id"]').val();

			ajaxData['state_id'] = state_id;
			$.ajax({
				url: "<?php echo base_url(); ?>survey/get_district",
				type: "POST",
				dataType: "json",
				data: ajaxData,
				...
				success : function(response){
					if(response.status == 1){
						...
						response.get_district.forEach(function(dist, index){
		...
		$('button[name="submit"]').on('click', function (event) {
			...
			if(surveycount == 0 && imageerror == 0){
				...
				formdata.append('survey_type', 'beneficiary');
				$.ajax({
