<div class="app-content content" style="margin-left: 0px;">
	<div class="content-wrapper">
  	<div class="content-body">
  		<div class="row">
  			<div class="col-md-12">
  				<h4 style="font-weight: bold;">All Activities</h4>
  			</div>
        <div class="col-md-12">
          <h4 class="bold"></h4>
          <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      <?php if(count($all_activity) > 0){
                        foreach ($all_activity as $key => $survey) { ?>
                          <tr>
                            <td><?php echo ++$key; ?></td>
                            <td><?php echo $survey['title']; ?></td>
                            <td><?php echo $survey['proj_name']; ?></td>
                            <td><?php echo $survey['last_updated']; ?></td>
                            <td><?php echo $survey['submitted_count']; ?></td>
                            <td><?php echo $survey['saved_count']; ?></td>
                            <td><?php echo $survey['nothingto_report_count']; ?></td>
                            <td>
                              <a href="<?php echo base_url(); ?>reports/view_activitydata/<?php echo $survey['proj_id']; ?>/<?php echo $survey['id']; ?>" target="_blank" class="btn btn-success btn-sm">View data</a>
                            </td>
                          </tr>
                        <?php }
                      }else{ ?>
...
<script type="text/javascript">
  ...
  $('body').on('change', '[name="project"]', function(event) {
    ...
    $.ajax({
      url: '<?php echo base_url(); ?>reports/activity/',
      data: ajaxData,
      type: 'POST',
      dataType: 'json',
      ...
      success: function(data) {
        ...
        var HTML = ``;
        for(var key in data.all_activity) {
          var survey = data.all_activity[key];
          HTML += `<tr>
            ...
            <td>${survey.nothingto_report_count}</td>
            <td>
