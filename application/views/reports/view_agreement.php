...
<div class="main-content">
	<div class="p-4">
		...
		<!-- Import tabular view -->
		<?php $this->load->view('reports/tabular_data.php', array('filename' => 'Plot Agreement Data')); ?>
	</div>
</div>
<!-- /Main content -->

<script type="text/javascript">
	var primary_key = 'agreement_id',
	url = '<?php echo base_url(); ?>reports/agreement',
	mapUrl = '<?php echo base_url(); ?>reports/get_map_locations/3';
	$(function() {
