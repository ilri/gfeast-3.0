<div class="app-content content" style="margin-left: 0px;">
	<div class="content-wrapper">
  	<div class="content-body">
  		<div class="row">
  			<div class="col-md-12">
  				<h4 style="font-weight: bold;">All Survey</h4>
  			</div>
        <div class="col-md-12">
          <h4 class="bold"></h4>
          <div class="card">
                      ...
                      <?php if(count($all_surveys) > 0){
                        foreach ($all_surveys as $key => $survey) { ?>
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url(); ?>reports/view_surveydata/<?php echo $survey['proj_id']; ?>/<?php echo $survey['id']; ?>" target="_blank" class="btn btn-success btn-sm">View data</a>
                            </td>
                          </tr>
                        <?php }
                      }else{ ?>
...
<script type="text/javascript">
  ...
  $('body').on('change', '[name="project"]', function(event) {
    ...
    $.ajax({
      url: '<?php echo base_url(); ?>reports/survey/',
      data: ajaxData,
      type: 'POST',
      dataType: 'json',
      ...
      success: function(data) {
        ...
        var HTML = ``;
        for(var key in data.all_surveys) {
          var survey = data.all_surveys[key];
          HTML += `<tr>
