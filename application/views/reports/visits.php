...
<div class="app-content content" style="margin-left: 0px;">
	<div class="content-wrapper">
  	<div class="content-body">
  		<div class="row">
  			<div class="col-md-12">
  				<h4 style="font-weight: bold;">All Visits</h4>
  			</div>
        <div class="col-md-12">
          <h4 class="bold"></h4>
          <div class="card">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <?php if(count($all_visits) > 0){
                        foreach ($all_visits as $key => $survey) { ?>
                          <tr>
                            <td><?php echo ++$key; ?></td>
                            ...
                            <td>
                              <a href="<?php echo base_url(); ?>reports/view_visitdata/<?php echo $survey['proj_id']; ?>/<?php echo $survey['id']; ?>" target="_blank" class="btn btn-success btn-sm">View data</a>
                            </td>
                          </tr>
                        <?php }
                      }else{ ?>
...
<script type="text/javascript">
  ...
  $('body').on('change', '[name="project"]', function(event) {
    ...
    $.ajax({
      url: '<?php echo base_url(); ?>reports/visits/',
      data: ajaxData,
      type: 'POST',
      dataType: 'json',
      ...
      success: function(data) {
        ...
        var HTML = ``;
        for(var key in data.all_visits) {
          var survey = data.all_visits[key];
          HTML += `<tr>
