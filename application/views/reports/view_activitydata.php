...
<div class="app-content content" style="margin-left: 0px;">
			...
			<div class="row">
				<div class="col-md-4">
					<h4 style="font-weight: bold;">
						<a href="" onclick="window.close()"  class="btn btn-icon btn-pure success px-0">
	...
	function loadAllLocationData(lastId){
		...
		$.ajax({
			url : "<?php echo base_url(); ?>/reports/get_activity_locations/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>",
			data : query_data,
			type : "POST",
			dataType : "JSON",
			error:function(){
