          ...
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item">
              <a class="navbar-brand" href="javascript:void(0);">
                <img class="brand-logo" src="<?php echo base_url('include/dist/img/ilri_logo.png'); ?>" style="height: 50px; width: 100%; margin-top: -10px;">
              </a>
            </li>
