        ...
        <div class="col-md-12 mt-10">
          <div class="card p-10">
            ...
            <form  action="javascript:void(0);" id="form">
              <input type="hidden" name="market_id" class='market_id' value="<?php if(!empty($market)){echo $market[0]->id;}?>">
              <div class="row">
                <div class="col-md-3">
                  <label>Name</label>
                  <input type="text" name="market_name" class="name form-control" placeholder="Enter market name here"  value="<?php if(!empty($market)){ echo $market[0]->name;}?>">
                ...
                <div class="col-md-3">
                  <!-- <label>Name</label>
                  <input type="text" name="name"  class="name form-control" placeholder="Enter name here" value="<?php if(!empty($market)){ $market[0]->name;}?>"><span class="latitude_err"></span> -->
                </div>
                <div class="col-md-3">
                  <!-- <label>longitude</label>
                  <input type="text" name="longitude"  class="longitude form-control" placeholder="Enter longitude here" value="<?php if(!empty($market)){ $market[0]->lng;}?>" >
...
<script>
  $(function(){
    $('#submit').click(function(){
      ...
      // console.log(market_id+"  "+market_name);
      var error=0;
      if(market_name==""){
        var error=error+1;
      ...
      if(market_name!="" && error=='0'){
         // console.log("market_name is not null"+market_name);
        $.ajax({
