        ...
        <div class="col-md-12 mt-10">
          <div class="card p-10">
            ...
            <form  action="javascript:void(0);" id="form">
              <input type="hidden" name="trainingpartners_id" class='trainingpartners_id' value="<?php if(!empty($trainingpartners)){echo $trainingpartners[0]->id;}?>">
              <div class="row">
                <div class="col-md-3">
                  <label>Name</label>
                  <input type="text" name="trainingpartners_name" class="name form-control" placeholder="Enter trainingpartners name here"  value="<?php if(!empty($trainingpartners)){ echo $trainingpartners[0]->name;}?>">
                ...
                <div class="col-md-3">
                  <!-- <label>Name</label>
                  <input type="text" name="name"  class="name form-control" placeholder="Enter name here" value="<?php if(!empty($trainingpartners)){ $trainingpartners[0]->name;}?>"><span class="latitude_err"></span> -->
                </div>
                <div class="col-md-3">
                  <!-- <label>longitude</label>
                  <input type="text" name="longitude"  class="longitude form-control" placeholder="Enter longitude here" value="<?php if(!empty($trainingpartners)){ $trainingpartners[0]->lng;}?>" >
...
<script>
  $(function(){
    $('#submit').click(function(){
      ...
      // console.log(trainingpartners_id+"  "+trainingpartners_name);
      var error=0;
      ...
      if(trainingpartners_name!="" && error=='0'){
        // console.log("trainingpartners_name is not null"+trainingpartners_name);
        $.ajax({
          ...
          data:{
            ...
            trainingpartners_name:trainingpartners_name,
          },
          ...
          // error:function(data){
          //  if(trainingpartners_id==""){
          //    $('#msg').html("Unable to Insert Training Partners");
          //  }
          //  else{
          //    $('#msg').html("Unable to Update Training Partners");
          //  }
          // }
        });
      }
