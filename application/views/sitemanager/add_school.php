    ...
    <div class="content-body" style="margin-bottom: 40px;">
      <div class="row">
        <div class="col-md-12">
          ...
          <h3 class="title"><?php if(!empty($this->uri->segment(3))){ echo 'Edit';}else{ echo 'Add';}?> Schools</h3>
        </div>
        ...
        <div class="col-md-12 mt-10">
          <div class="card p-10">
            ...
            <form  action="javascript:void(0);" id="form">
              <input type="hidden" name="school_id" class='school_id' value="<?php if(!empty($school)){echo $school[0]->school_id;}?>">
              <div class="row">
                <div class="col-md-3">
                  <label>Name</label>
                  <input type="text" name="school_choice" class="name form-control" placeholder="Enter school name here"  value="<?php if(!empty($school)){ echo $school[0]->school_choice;}?>">
                ...
                <div class="col-md-3">
                  <!-- <label>Name</label>
                  <input type="text" name="name"  class="name form-control" placeholder="Enter name here" value="<?php if(!empty($school)){ $school[0]->name;}?>"><span class="latitude_err"></span> -->
                </div>
                <div class="col-md-3">
                  <!-- <label>longitude</label>
                  <input type="text" name="longitude"  class="longitude form-control" placeholder="Enter longitude here" value="<?php if(!empty($school)){ $school[0]->lng;}?>" >
...
<script>
  $(function(){
    $('#submit').click(function(){
      ...
      var school_choice=$('.name').val();

      // console.log(school_id+"  "+school_choice);
      var error=0;
      if(school_choice==""){
        var error=error+1;
      ...
      if(school_choice!="" && error=='0'){
         console.log("school_choice is not null"+school_choice);
        $.ajax({
