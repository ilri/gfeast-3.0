    ...
    <div class="content-body" style="margin-bottom: 40px;">
      <div class="row">
        <div class="col-md-12">
          ...
          <h3 class="title"><?php if(!empty($this->uri->segment(3))){ echo 'Edit';}else{ echo 'Add';}?> Finance Accessed Types</h3>
        </div>
        ...
        <div class="col-md-12 mt-10">
          <div class="card p-10">
            ...
            <form  action="javascript:void(0);" id="form">
              <input type="hidden" name="financingaccessed_type_id" class='financingaccessed_type_id' value="<?php if(!empty($financingaccessed_type)){echo $financingaccessed_type[0]->id;}?>">
              <div class="row">
                <div class="col-md-3">
                  <label>Name</label>
                  <input type="text" name="financingaccessed_type_name" class="name form-control" placeholder="Enter financing Accessed Type name here"  value="<?php if(!empty($financingaccessed_type)){ echo $financingaccessed_type[0]->name;}?>">
                ...
                <div class="col-md-3">
                  <!-- <label>Name</label>
                  <input type="text" name="name"  class="name form-control" placeholder="Enter name here" value="<?php if(!empty($financingaccessed_type)){ $financingaccessed_type[0]->name;}?>"><span class="latitude_err"></span> -->
                </div>
                <div class="col-md-3">
                  <!-- <label>longitude</label>
                  <input type="text" name="longitude"  class="longitude form-control" placeholder="Enter longitude here" value="<?php if(!empty($financingaccessed_type)){ $financingaccessed_type[0]->lng;}?>" >
...
<script>
  $(function(){
    $('#submit').click(function(){
      ...
      // console.log(financingaccessed_type_id+"  "+financingaccessed_type_name);
      var error=0;
      ...
      if(financingaccessed_type_name!="" && error=='0'){
         // console.log("financingaccessed_type_name is not null"+financingaccessed_type_name);
        $.ajax({
          url:"<?php echo base_url();?><?php echo $this->uri->segment(1);?>/addfinancingaccessed_type",
          type:'post',
          dataType:'json',
          data:{
            financingaccessed_type_id:financingaccessed_type_id,
            financingaccessed_type_name:financingaccessed_type_name,
          },
