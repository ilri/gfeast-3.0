				...
				<div class="col-md-12 mt-10">
					<div class="card p-10">
						...
						<form  action="javascript:void(0);" id="form">
							<input type="hidden" name="yesno_id" class='yesno_id' value="<?php if(!empty($yesno)){echo $yesno[0]->id;}?>">
							<div class="row">
								<div class="col-md-3">
									<label>Name</label>
									<input type="text" name="yesno_name" class="name form-control" placeholder="Enter yesno name here"  value="<?php if(!empty($yesno)){ echo $yesno[0]->name;}?>">
								...
								<div class="col-md-3">
									<!-- <label>Name</label>
									<input type="text" name="name"  class="name form-control" placeholder="Enter name here" value="<?php if(!empty($yesno)){ $yesno[0]->name;}?>"><span class="latitude_err"></span> -->
								</div>
								<div class="col-md-3">
									<!-- <label>longitude</label>
									<input type="text" name="longitude"  class="longitude form-control" placeholder="Enter longitude here" value="<?php if(!empty($yesno)){ $yesno[0]->lng;}?>" >
...
<script>
	$(function(){
		$('#submit').click(function(){
			...
			// console.log(yesno_id+"  "+yesno_name);
			var error=0;
			if(yesno_name==""){
				var error=error+1;
			...
			if(yesno_name!="" && error=='0'){
				// console.log("yesno_name is not null"+yesno_name);
				$.ajax({
					...
					// error:function(data){
					// 	if(yesno_id==""){
					// 		$('#msg').html("Unable to Insert Yes/No");
					// 	}
					// 	else{
					// 		$('#msg').html("Unable to Update Yes/No");
					// 	}
					// }
				});
			}
